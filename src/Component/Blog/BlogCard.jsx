...
function BlogCard({ id, image, date, title, subtitle, paragraph }) {
  ...
  return (
    <div
      className="max-w-sm bg-white rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-xl hover:-translate-y-1"
      onClick={id}
    >
      {/* Card Image */}
      ...
      <div className="p-5">
        ...
        <p className="text-custom-text-darkGray text-sm mb-4">{subtitle}</p>
